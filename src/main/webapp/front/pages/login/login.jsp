    ...
    <form class="layui-form login-form form">
      <div class="form-inner">
        ...
        <div class="btn-group">
          ...
          <a class="btn--text" v-if="item.tableName!='users'" v-for="(item,index) in menu" v-bind:key="index" :href="'javascript:registerClick(\''+item.tableName+'\')'">注册{{item.roleName.replace('注册','')}}</a>
        </div>
      </div>
    </form>
  </div>
